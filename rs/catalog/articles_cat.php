<?php
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    if ($cat != '' ) {
      ...
      $art = $pdo->query("SELECT count(*) as nb FROM articles WHERE cat = '$cat'");
      ...
      $sql = "SELECT * FROM articles WHERE cat = '$cat' ORDER BY id DESC $limit";
                   ...
                   if (isset($cat)) {
                      ...
                      ?>
                        ...
                        <li aria-current="page" class="bdcb-itm active">
                          ...
                          <a href="index.php?m=<?=$cat?>" id="bdcbhm"><?=$cat?></a>
